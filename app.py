# app.py — Gerador de Evangelho (v19.5 - ESTÁVEL)
# Base: v19 (Roteiro OK) + Features Visuais (Legendas, Mobile Title, Música Persistente)
import os
import re
import json
import time
...
# =========================
# Lógica de Roteiro (ESTÁVEL v19)
# =========================
# Mantendo as funções originais que funcionam bem
...
st.markdown("---"); st.caption("Studio Jhonata v19.5 - Estável")